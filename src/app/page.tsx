  ...
  return (
    <div className={theme}>
      <div className="min-h-screen flex flex-col justify-center items-center gap-10 bg-indigo-50 dark:bg-slate-900 selection:bg-violet-400 dark:selection:bg-violet-700">
        <div className="max-w-[960px] p-5 bg-slate-100 dark:bg-zinc-900 rounded-lg flex gap-4 border border-zinc-900 dark:border-zinc-200 hover:shadow-cartom hover:dark:shadow-cartom-dark duration-300">
